Architect and develop a primitive copy of Dictionary<string, int>, using only primitive types. .NET collections should not be used (List<T>, Dictionary<TKey,TValue>, HashSet<T> and others).
